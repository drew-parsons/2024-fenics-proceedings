...
\begin{equation}
    ...
    \label{weak_CS}
\end{equation}
for all $b_i$, which adds to \eqnref{weak_Boltzmann}, the weak formulation for the Boltzmann equation, together generating the strong formulation of  \eqnref{general_Boltzmann}, the modified Boltzmann equation.
...
shown in \figref{fig:throttling_algorithm}.
