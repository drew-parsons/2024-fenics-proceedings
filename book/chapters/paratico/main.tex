...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapters/chp1/graphics/finalx4.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth, height = 0.3\textheight]{chapters/chp1/graphics/1p2x4.jpg}
...
\begin{figure}
    ...
    \begin{minipage}{\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth, height = 0.2\textheight]{chapters/chp1/graphics/RealData3DVar.JPG}
    ...
    \begin{minipage}{\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth, height = 0.2\textheight]{chapters/chp1/graphics/WSS3DVar.JPG}
